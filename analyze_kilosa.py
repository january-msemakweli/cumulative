...
markdown = f"""# Kilosa Eye Camp Report
...
plt.tight_layout()
plt.savefig('kilosa_chart_conditions_top10.png', dpi=300, bbox_inches='tight')
plt.close()
...
![Top 10 Conditions](kilosa_chart_conditions_top10.png)
"""
...
plt.grid(axis='y', alpha=0.3, linestyle='--')
plt.tight_layout()
plt.savefig('kilosa_chart_procedures.png', dpi=300, bbox_inches='tight')
plt.close()
...
![Procedures Distribution](kilosa_chart_procedures.png)
"""
...
plt.grid(axis='y', alpha=0.3, linestyle='--')
plt.tight_layout()
plt.savefig('kilosa_chart_gender_comparison.png', dpi=300, bbox_inches='tight')
plt.close()
...
![Gender Comparison](kilosa_chart_gender_comparison.png)
"""
...
plt.grid(axis='y', alpha=0.3, linestyle='--')
plt.tight_layout()
plt.savefig('kilosa_chart_age_comparison.png', dpi=300, bbox_inches='tight')
plt.close()

markdown += """![Age Group Comparison](kilosa_chart_age_comparison.png)
"""

# Write to file
with open('kilosa_report.md', 'w', encoding='utf-8') as f:
    f.write(markdown)
