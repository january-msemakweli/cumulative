...
markdown = f"""# Mkundi Eye Camp Report
...
plt.tight_layout()
plt.savefig('mkundi_chart_conditions_top10.png', dpi=300, bbox_inches='tight')
plt.close()
...
![Top 10 Conditions](mkundi_chart_conditions_top10.png)
"""
...
plt.grid(axis='y', alpha=0.3, linestyle='--')
plt.tight_layout()
plt.savefig('mkundi_chart_procedures.png', dpi=300, bbox_inches='tight')
plt.close()
...
![Procedures Distribution](mkundi_chart_procedures.png)
"""
...
plt.grid(axis='y', alpha=0.3, linestyle='--')
plt.tight_layout()
plt.savefig('mkundi_chart_gender_comparison.png', dpi=300, bbox_inches='tight')
plt.close()
...
![Gender Comparison](mkundi_chart_gender_comparison.png)
"""
...
plt.grid(axis='y', alpha=0.3, linestyle='--')
plt.tight_layout()
plt.savefig('mkundi_chart_age_comparison.png', dpi=300, bbox_inches='tight')
plt.close()

markdown += """![Age Group Comparison](mkundi_chart_age_comparison.png)
"""

# Write to file
with open('mkundi_report.md', 'w', encoding='utf-8') as f:
    f.write(markdown)
