...
The eye camp successfully performed **301 surgical procedures** on patients in Nkundi. This represents a substantial contribution to addressing the eye care needs of the community, providing critical interventions that restore vision and prevent blindness. Each procedure represents a life-changing intervention, enabling patients to regain independence, return to work, and improve their overall quality of life.

---

## 2. Frequency Distribution of Conditions

Understanding the prevalence of different eye conditions is crucial for planning future eye camps and allocating resources effectively. The following analysis provides insights into the most common eye health issues affecting the Nkundi community.
...
![Top 10 Conditions](nkundi_chart_conditions_top10.png)

**Key Findings:**
- **Cataracts** emerged as the most prevalent condition, affecting a significant proportion of condition occurrences. This aligns with global patterns where cataracts are the leading cause of preventable blindness, particularly in older populations.
- **Pterygium** was also a common condition, often associated with environmental factors such as UV exposure and dry, dusty conditions.
...
|-----------|-----------|----------|-------|
| SICS | 103 (66.03%) | 108 (71.05%) | 211 (68.51%) |
| EXCISION | 49 (31.41%) | 36 (23.68%) | 85 (27.60%) |
...
| **Total** | **156 (100.00%)** | **152 (100.00%)** | **308 (100.00%)** |


#### Chart: Procedures Distribution

![Procedures Distribution](nkundi_chart_procedures.png)

**Impact Analysis:**
- **Small Incision Cataract Surgery (SICS)** accounted for the majority of procedures, demonstrating the camp's focus on addressing the primary cause of vision loss in the community.
- **Pterygium Excision** procedures addressed both functional and cosmetic concerns, improving patients' quality of life.
...
Visual acuity outcomes are the most critical measure of the eye camp's success. This section tracks patient vision improvements from pre-operative assessment through post-operative follow-ups at 1 day and 2 weeks, demonstrating the transformative impact of the surgical interventions.

### 3.1 VA Distribution Across Time Points

| Visual Acuity | Pre-op | 1 Day Post-op | 2 Weeks Post-op | Change (Pre-op to 2 Weeks) |
|---------------|--------|---------------|-----------------|---------------------------|
| 6/6 | 29 (9.70%) | 42 (14.05%) | 54 (19.01%) | +86.21% |
| 6/9 | 27 (9.03%) | 30 (10.03%) | 28 (9.86%) | +3.70% |
| 6/12 | 7 (2.34%) | 5 (1.67%) | 17 (5.99%) | +142.86% |
| 6/18 | 11 (3.68%) | 18 (6.02%) | 26 (9.15%) | +136.36% |
| 6/24 | 6 (2.01%) | 10 (3.34%) | 72 (25.35%) | +1100.00% |
| 6/36 | 3 (1.00%) | 20 (6.69%) | 42 (14.79%) | +1300.00% |
| 6/60 | 5 (1.67%) | 86 (28.76%) | 36 (12.68%) | +620.00% |
| CF1M | 17 (5.69%) | 4 (1.34%) | 0 (0.00%) | -100% |
| CF2M | 25 (8.36%) | 11 (3.68%) | 1 (0.35%) | -96.00% |
| CF3M | 34 (11.37%) | 12 (4.01%) | 2 (0.70%) | -94.12% |
| CF4M | 33 (11.04%) | 14 (4.68%) | 3 (1.06%) | -90.91% |
| CF5M | 13 (4.35%) | 40 (13.38%) | 2 (0.70%) | -84.62% |
| CFN | 25 (8.36%) | 4 (1.34%) | 0 (0.00%) | -100% |
| HM | 52 (17.39%) | 2 (0.67%) | 0 (0.00%) | -100% |
| PL | 11 (3.68%) | 0 (0.00%) | 0 (0.00%) | -100% |
| NPL | 1 (0.33%) | 1 (0.33%) | 1 (0.35%) | +0.00% |

**Total Patients with Pre-op VA: 299**
**Total Patients with 1 Day Post-op VA: 299**
**Total Patients with 2 Weeks Post-op VA: 284**
...
- The percentage of patients achieving **6/6 vision (best possible)** increased from 9.70% pre-operatively to 19.01% at 2 weeks post-operatively - an **86% increase**, representing life-changing outcomes for these patients.
- Patients achieving **6/24 vision** showed remarkable improvement, increasing from 2.01% to 25.35% - a **1,100% increase**.
- The dramatic reduction in patients with **Hand Motion (HM)** vision from 17.39% to 0% (100% reduction) demonstrates the camp's success in addressing severe vision impairment.
...
| Patient ID | Patient Name | Pre-op VA | 2 Weeks Post-op VA |
|------------|--------------|-----------|---------------------|
| MC0925-5335 | Asha Chembe | PL | 6/6 |
| MC0925-3354 | Foibe Azaria | CF4M | 6/6 |
| MC0925-2649 | Maneno Khamis | CF3M | 6/6 |
| MC0925-4642 | Amidu Salehe | CF3M | 6/6 |
| MC0925-4302 | Ansila Bundala | CF2M | 6/6 |
| MC0925-200 | Eufrasia Omari | 6/36 | 6/6 |
| MC0925-568 | Habibu Ibrahim | 6/24 | 6/6 |
| MC0925-1832 | Shamsi Khatibu | 6/18 | 6/6 |
| MC0925-1887 | Raphael Mkundi | 6/18 | 6/6 |
| MC0925-4193 | Doreena Marcha | 6/18 | 6/6 |

**Success Stories:**
These ten patients represent the most remarkable transformations achieved during the eye camp. Many achieved **6/6 vision (perfect vision)** at the 2-week follow-up, having started with various levels of vision impairment ranging from Perception of Light (PL) to Counting Fingers at various distances, and some with moderate vision loss. These outcomes exemplify the life-changing impact of the surgical interventions, restoring not just vision but hope, independence, and the ability to fully participate in daily activities.
...
![Gender Comparison](nkundi_chart_gender_comparison.png)
...
![Age Group Comparison](nkundi_chart_age_comparison.png)
...
The Nkundi Eye Camp conducted by The Mo Dewji Foundation achieved remarkable success in addressing the eye care needs of the community. With **301 procedures** performed, the camp made a significant impact on preventing blindness and restoring vision.
...
The success of this eye camp demonstrates the critical importance of accessible eye care services in underserved communities and the transformative power of surgical interventions in restoring vision and improving lives.
